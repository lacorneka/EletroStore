	...
	<div class="span12">
		...
		<table class="table table-compare">
			...
			<tr>
				...
				<td><a href="#"><img src="img/92x92.jpg"
			...
			<tr>
				...
				<td class="price"><span class="strike-through">$200.00</span>
					$150.00</td>
			...
			<tr>
				...
				<td>
					<ul class="rating">
						...
						<li><i class="star-off"></i></li>
					</ul> <small>Based On (2) Reviews</small>
				</td>
				<td>
					<ul class="rating">
						<li><i class="star-on"></i></li>
						...
						<li><i class="star-off"></i></li>
						<li><i class="star-off"></i></li>
					</ul> <small>Based On (16) Reviews</small>
				</td>
				<td>
					<ul class="rating">
						<li><i class="star-off"></i></li>
						...
						<li><i class="star-off"></i></li>
						<li><i class="star-off"></i></li>
					</ul> <small>Based On (0) Reviews</small>
				</td>
				<td>
					<ul class="rating">
						<li><i class="star-off"></i></li>
			...
			<tr>
				...
				<td>Quisque tincidunt lacus et quam tempor elementum. Nulla
					vulputate tellus ac erat cursus tristique. Nulla non orci nec <a
					href="#" data-tip="tooltip" data-title="More" data-placement="top">[...]</a>
				</td>
				<td>Quisque tincidunt lacus et quam tempor elementum. Nulla
					vulputate tellus ac erat cursus tristique. Nulla non <a href="#"
					data-tip="tooltip" data-title="More" data-placement="top">[...]</a>
				</td>
				<td>Quisque tincidunt lacus et quam tempor elementum. Nulla
					vulputate tellus ac erat cursus tristique. Nulla non orci <a
					href="#" data-tip="tooltip" data-title="More" data-placement="top">[...]</a>
				</td>
				<td>Quisque tincidunt lacus et quam tempor elementum. Nulla
					vulputate tellus ac erat cursus tristique. Nulla non orci <a
