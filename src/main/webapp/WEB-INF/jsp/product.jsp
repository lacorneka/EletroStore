	...
	<div class="span12">
						...
						<div class="product-inputs">
							<form method="post" action="http://egythemes.com/shoppest/page">
								<div class="input-append">
									<input class="span2" type="text" name="" value=""
										placeholder="1">
		...
		<div class="product-tab">
			<ul class="nav nav-tabs">
				...
				<li><a href="#return-info" data-toggle="tab">Return Info</a></li>
				...
				<div class="tab-pane" id="make-review">
					<form method="post" action="http://egythemes.com/shoppest/page"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="#" class="span8" id="inputName"
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="#" class="span8" id="inputReview"
