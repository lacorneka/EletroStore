	...
	<form:form method="POST" commandName="customer" action="registering.do"
		...
		<!--end control-group-->
			...
			<div class="controls">
				...
				<span style="margin-left: 10px;"><form:errors path="retypepassword" cssClass="error text-error" /></span>
			</div>
		</div>
		<!--end control-group-->
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span style="margin-left: 10px;"><form:errors path="firstname" cssClass="error text-error" /></span>								
			</div>
		</div>
		<!--end control-group-->
		...
		<div class = "control-group">
			...
			<div class="controls">
				...
				<span style="margin-left: 10px;"><form:errors path="lastname" cssClass="error text-error" /></span>								
			</div>
		</div>
		<!--end control-group-->
		...
		<div class = "control-group">
			...
			<div class="controls">
				...
				<span style="margin-left: 10px;"><form:errors path="phonenumber" cssClass="error text-error" /></span>								
			</div>
		</div>
		<!--end control-group-->
		...
		<div class = "control-group">
			...
			<div class="controls">
				<form:input path="address" placeholder="227 Nguyen Van Cu, Ward 5, HCMC" />
				<span style="margin-left: 10px;"><form:errors path="address" cssClass="error text-error" /></span>								
			</div>
		</div>
		<!--end control-group-->
