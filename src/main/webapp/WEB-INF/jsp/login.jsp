...
<div class="span4">
	...
	<div class="new-customer">
		<p>By creating an account you will be able to shop faster, be up
			...
			previously made.</p>
		<a href="register.do" class="btn">Create Account</a>
	</div>
</div>
<!--end span4-->
...
<div class="span5">
	...
	<form action="j_spring_security_check" method="post" id="loginForm">
		...
		<div class="controls">
			<label for="j_password">Your Password: <span
				class="text-error">*</span></label> <input class="text" type="password"
				id="j_password" name="j_password" id="j_password" value=""
				placeholder="**************">
		</div>
